 ...
 */
function wfm_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['wfm_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('wfm sample setting'),
  '#default_value' => theme_get_setting('wfm_example'),
